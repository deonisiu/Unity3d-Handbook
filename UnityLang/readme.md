...
### <a name="tag10">Именованные параметры</a>
...
### <a name="tag11">Массив параметров params</a>
...
### <a name="tag12">Перечисления enum</a>
...
### <a name="tag13">Структуры struct</a>
...
### <a name="tag14">Кортежи (работа с набором значений)</a>
...
## <a name="tag15">Обработка исключений</a>
...
### <a name="tag16">Обработка нескольких исключений</a>
...
### <a name="tag18">Фильтры исключений</a>
...
### <a name="tag19">Переменные-ссылки и возвращение ссылки</a>
...
### <a name="tag21">Ключевое слово this</a>
...
### <a name="tag22">Инициализаторы объектов</a>
...
### <a name="tag23">Модификаторы доступа</a>
...
### <a name="tag24">Константы и поля для чтения</a>
#### Константы
...
### <a name="tag25">Свойства и инкапсуляция</a>
#### Свойства
...
### <a name="tag27">Автоматические свойства</a>
