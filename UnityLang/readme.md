...
* [Фильтры исключений](#tag17)
* [Переменные-ссылки и возвращение ссылки](#tag18)
* [Классы в C#](#tag19)
* [Ключевое слово this](#tag20)
* [Инициализаторы объектов](#tag21)
* [Модификаторы доступа](#tag22)
* [Константы и поля для чтения](#tag23)
* [Свойства и инкапсуляция](#tag24)
* [Инкапсуляция](#tag25)
* [Автоматические свойства](#tag26)
...
### <a name="tag1">Примитивные типы данных</a>
...
### <a name="tag2">Неявная типизация</a>
...
### <a name="tag3">Преобразования типов данных</a>
...
### <a name="tag5">Многомерные массивы</a>
Двухмерный массив:  
...
### <a name="tag9">Необязательные параметры</a>
...
### <a name="tag10">Массив параметров params</a>
...
### <a name="tag11">Перечисления enum</a>
...
### <a name="tag12">Структуры struct</a>
...
### <a name="tag13">Кортежи (работа с набором значений)</a>
...
## <a name="tag14">Обработка исключений</a>
...
### <a name="tag15">Обработка нескольких исключений</a>
...
### <a name="tag17">Фильтры исключений</a>
...
### <a name="tag18">Переменные-ссылки и возвращение ссылки</a>
...
### <a name="tag20">Ключевое слово this</a>
...
### <a name="tag21">Инициализаторы объектов</a>
...
### <a name="tag22">Модификаторы доступа</a>
...
### <a name="tag23">Константы и поля для чтения</a>
#### Константы
...
### <a name="tag24">Свойства и инкапсуляция</a>
#### Свойства
...
### <a name="tag26">Автоматические свойства</a>
