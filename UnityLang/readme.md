...
### <a name="tag1">Примитивные типы данных</a> - [содержание](#up)
...
### <a name="tag2">Неявная типизация</a> - [содержание](#up)
...
### <a name="tag3">Преобразования типов данных</a> - [содержание](#up)
...
## <a name="tag4">Массивы</a> - [содержание](#up)
...
### <a name="tag5">Многомерные массивы</a> - [содержание](#up)
Двухмерный массив:  
...
### <a name="tag6">Массив массивов</a> - [содержание](#up)
...
## <a name="tag7">Функции</a> - [содержание](#up)
...
### <a name="tag8">Модификатор out</a> - [содержание](#up)
...
### <a name="tag9">Необязательные параметры</a> - [содержание](#up)
...
### <a name="tag10">Именованные параметры</a> - [содержание](#up)
...
### <a name="tag11">Массив параметров params</a> - [содержание](#up)
...
### <a name="tag12">Перечисления enum</a> - [содержание](#up)
...
### <a name="tag13">Структуры struct</a> - [содержание](#up)
...
### <a name="tag14">Кортежи (работа с набором значений)</a> - [содержание](#up)
...
## <a name="tag15">Обработка исключений</a> - [содержание](#up)
...
### <a name="tag16">Обработка нескольких исключений</a> - [содержание](#up)
...
### <a name="tag17">Оператор throw</a> - [содержание](#up)
...
### <a name="tag18">Фильтры исключений</a> - [содержание](#up)
...
### <a name="tag19">Переменные-ссылки и возвращение ссылки</a> - [содержание](#up)
...
## <a name="tag20">Классы в C#</a> - [содержание](#up)
...
### <a name="tag21">Ключевое слово this</a> - [содержание](#up)
...
### <a name="tag22">Инициализаторы объектов</a> - [содержание](#up)
...
### <a name="tag23">Модификаторы доступа</a> - [содержание](#up)
...
### <a name="tag24">Константы и поля для чтения</a> - [содержание](#up)
#### Константы
...
### <a name="tag25">Свойства и инкапсуляция</a> - [содержание](#up)
#### Свойства
...
#### <a name="tag26">Инкапсуляция</a> - [содержание](#up)
...
### <a name="tag27">Автоматические свойства</a> - [содержание](#up)
